...
type RayCaster interface {
	CastRay(origin *Point2D, world world.WorldMap, angle float64, maxDistance float64) *Point2D
}
...
func (raycaster *RayCasterImpl) CastRay(origin *Point2D, world world.WorldMap, angle float64, maxDistance float64) *Point2D {
	...
	var verticalIntersectStep, horizontalIntersectStep Point2D
	...
	var verticalIntersect, horizontalIntersect Point2D
...
func (*RayCasterImpl) checkHorizontalCollision(world world.WorldMap, horizontalIntersect *Point2D, horizontalIntersectStepY float64) bool {
	result := false
...
func (*RayCasterImpl) checkVerticalCollision(world world.WorldMap, verticalIntersect *Point2D, verticalIntersectStepX float64) bool {
	result := false
