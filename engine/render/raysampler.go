...
func CreateRaySamplerForAnsiColorTerminal(first float64, multiplicator float64, maxLimit float64, wallStartColor int, wallEndColor int, screenHeight int, backgroundRange []float32, backgroundColors []int) (g *GradientRaySampler, err error) {
	if first < 0.0 {
