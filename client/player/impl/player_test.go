...
func TestActionKeyUp(t *testing.T) {
	...
	player := NewPlayer("playerID", state, worldMap, mathHelper, nil, nil)
...
func TestNewPlayableCharacter(t *testing.T) {
	...
	player := NewPlayer("playerID", playerState, worldMap, mathHelper, nil, nil)
...
func TestPlayerStart(t *testing.T) {
	...
	player := NewPlayer("playerID", state, worldMap, mathHelper, quit, nil)
	go func() {
