...
func TestCreateRaySamplerForAnsiColorTerminal(t *testing.T) {
	...
	assert.Equal(t, tcell.StyleDefault.Background(5), gradientRaySampler.GetWallStyleFromDistance(4))
	assert.Equal(t, tcell.StyleDefault.Background(5), gradientRaySampler.GetWallStyleFromDistance(5))
	assert.Equal(t, tcell.StyleDefault.Background(5), gradientRaySampler.GetWallStyleFromDistance(6))
}
